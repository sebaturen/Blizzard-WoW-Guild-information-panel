...
<jsp:useBean id="guild" class="com.blizzardPanel.gameObject.guild.Guild" scope="application"/>
...
<% 
    guild = new Guild.Builder(61031120).fullLoad(true).build();
